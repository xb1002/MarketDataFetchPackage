...
@pytest.fixture(scope="module")
def source() -> BybitUSDTPerpDataSource:
    client = BybitUSDTPerpDataSource(base_url=BASE_URL)
    yield client
    client.close()
...
def _call_or_skip(fn):
    try:
        ...
        pytest.skip(f"Bybit API unavailable: {exc}")


@pytest.mark.network
@pytest.mark.integration
def test_get_price_klines_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_index_price_klines_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_mark_price_klines_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
    window = HistoricalWindow(symbol=symbol, interval=Interval.MINUTE_1, limit=3)
...
@pytest.mark.network
@pytest.mark.integration
def test_get_premium_index_klines_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
    window = HistoricalWindow(symbol=symbol, interval=Interval.MINUTE_1, limit=3)
...
@pytest.mark.network
@pytest.mark.integration
def test_get_funding_rate_history_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_latest_price_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_latest_mark_price_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_latest_index_price_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_latest_premium_index_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_latest_funding_rate_point_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
@pytest.mark.network
@pytest.mark.integration
def test_get_open_interest_snapshot_live(source: BybitUSDTPerpDataSource, symbol: Symbol) -> None:
...
def test_price_kline_limit_validation(symbol: Symbol) -> None:
    client = BybitUSDTPerpDataSource(base_url=BASE_URL)
    window = HistoricalWindow(symbol=symbol, interval=Interval.MINUTE_1, limit=1500)
...
def test_funding_limit_validation(symbol: Symbol) -> None:
    client = BybitUSDTPerpDataSource(base_url=BASE_URL)
    window = FundingRateWindow(symbol=symbol, limit=500)
